...
mapxy <- function(a = NA){
  plot(x, y, asp = a) # x and y are the predefined bottom-left and top-right corners of the rectangle
  rect(xmin, ymin, xmax, ymax)
}

mapxy(1:1) # 1:1 is the ratio
```
...
**Does the p-value let you reject the null hypothesis?**
Since the p-value is 0.5, we cannot reject the null hypothesis that it is randomly distributed. Thus, they seem completely randomly distributed.
...
# Run a quadrat test
quadrat.test(p_cluster, alternative = "clustered") # nor significant
...
# Run a quadrat test
quadrat.test(p_regular, alternative = "regular") # super significant
```
...
# Run a quadrat test - it takes a ppp object (as in the .rds file)
quadrat.test(p1, alternative = "regular") # p-value = 0.97
quadrat.test(p1, alternative = "clustered") # Signifiant, p-value = 0.02

quadrat.test(p2, alternative = "regular") # p-value = 1
quadrat.test(p2, alternative = "clustered") # Signifiant, p-value < 0.000006

# Asnwer 3 --> they are both clustered
